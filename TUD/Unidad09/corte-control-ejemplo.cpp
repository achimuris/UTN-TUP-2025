...
void listarPresentismo(Presentismo vec[], int n)
{
    ...
    while (i < n)
    {
        ...
        cout << "Materia : " << key << " faltas : " << ausentes << endl;
    }
...
{
    Presentismo datos[] = {
        {11709099, 20200504, 1, true},
        {11709099, 20200525, 1, true},
        {13423223, 20200504, 1, false},
        {12936274, 20200518, 2, false}};
